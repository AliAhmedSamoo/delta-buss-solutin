...
function Admin() {
    ...
    useEffect(() => {
        ...
        fetch("https://localhost:1337/user", requestOptions)
            .then(response => response.json())
            .then(result => setuser(result))
            .catch(error => console.log('error', error));

        fetch("https://localhost:1337/apblog", requestOptions)
            .then(response => response.json())
                            ...
                            <div>
                                ...
                                <button className='bbttnn'
                                    onClick={async () => {
                                        ...
                                        await fetch("https://localhost:1337/dtluser", requestOptions)
                                            .then(response => response.json())
                                            .then(result => {
                                                setuser(result)
                        ...
                        <div className='blogItem-wrap'>
                            ...
                            <div className='bttttof' style={{ width: '100%' }}><button className='bbttnn3'
                                ...
                                onClick={async () => {
                                    ...
                                    await fetch("https://localhost:1337/dtlapblog", requestOptions)
                                        .then(response => response.json())
                                        .then(result => {
                                            setapblogs(result)
                            ...
                            >Remove</button><button className='bbttnn2'
                                ...
                                onClick={() => {
                                    ...
                                    fetch("https://localhost:1337/uploadblog", requestOptions)
                                        .then(response => response.json())
                                        .then(result => {
                        ...
                        <div className='blogItem-wrap'>
                            ...
                            <div className='bttttof' style={{ width: '100%' }}><button className='bbttnn3'
                                ...
                                onClick={async () => {
                                    ...
                                    await fetch("https://localhost:1337/dtlblog", requestOptions)
                                        .then(response => response.json())
                                        .then(result => {
                                            setblogList(result)
